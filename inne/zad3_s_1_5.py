...
probabilities_a, average_rounds = probability_of_loss(p, initial_capital_A, total_capitals, simulation_no)
plt.figure(figsize=(10, 6))
plt.plot(range(len(probabilities_a)), probabilities_a, label="p = 1/5", color="blue")
print(f"Średnia długość rozgrywki dla p = {p}: {average_rounds} tur")
